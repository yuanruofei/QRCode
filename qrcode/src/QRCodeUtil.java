...
public class QRCodeUtil {
	...
	public static void main(String[] args) {
		...
		String filePath = "D:/upload/哈哈.png";
		// String filePath = "D:/upload/baidu.png";
		File qrFile = new File(filePath);

		// 二维码内容
		 String encodeddata = "熊老师说她上课会很凶的 是真的吗? 熊大(哈哈)  @xrf";
//		 String encodeddata = "https://www.baidu.com";
//		 String encodeddata ="http://b289.photo.store.qq.com/psb?/V10TV1HD2QZ8b7/P9iTtf6U.12Ep*xGAewlQzNrg7l4GC.V6lDyis8geQc!/b/dCEBAAAAAAAA&bo=wAMABcADAAURECc!&rf=viewer_311";
